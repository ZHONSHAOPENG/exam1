package com.example.admin.exam.dao;
...
public class DbBeanDao extends AbstractDao<DbBean, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Htmls = new Property(3, String.class, "htmls", false, "HTMLS");
    ...
    protected final void bindValues(DatabaseStatement stmt, DbBean entity) {
        ...
        String htmls = entity.getHtmls();
        if (htmls != null) {
            stmt.bindString(4, htmls);
        }
    ...
    public DbBean readEntity(Cursor cursor, int offset) {
        DbBean entity = new DbBean( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // htmls
    ...
    public void readEntity(Cursor cursor, DbBean entity, int offset) {
        ...
        entity.setHtmls(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
